...
?>
<section class="relative flex items-center justify-center w-[260px] h-[160px] group cursor-pointer" data-table-id="<?= $table['id'] ?>">
        ...
        <div class="w-[200px] h-[100px] border-2 rounded-md <?= $colorClasses ?>"></div>
        ...
        <?= $table['status'] === 'free' ? 'bg-green-500 text-white' : ($table['status'] === 'occupied' ? 'bg-orange-500 text-white' : 'bg-yellow-500 text-gray-1translate-x-1100') ?>">
